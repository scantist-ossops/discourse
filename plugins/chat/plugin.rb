...
after_initialize do
  ...
  register_about_stat_group("chat_users", expose_via_api: true) { Chat::Statistics.about_users }
  register_about_stat_group("chat_channels", expose_via_api: true) { Chat::Statistics.about_channels }
